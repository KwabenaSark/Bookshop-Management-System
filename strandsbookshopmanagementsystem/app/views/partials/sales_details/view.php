...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Sales Details</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-quantity_ordered">
                                        ...
                                        <td class="value"> <?php echo $data['quantity_ordered']; ?></td>
                                    </tr>
                                    <tr  class="td-amount">
                                    ...
                                    <tr  class="td-book">
                                        ...
                                        <td class="value"> <?php echo $data['book']; ?></td>
                                    </tr>
                                    <tr  class="td-role_name">
                                        <th class="title"> Role Name: </th>
                                        <td class="value"> <?php echo $data['role_name']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
