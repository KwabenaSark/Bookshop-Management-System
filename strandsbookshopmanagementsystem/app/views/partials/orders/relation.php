                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="orders-relation-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-users_user_name"> Users User Name</th>
                                                <th  class="td-users_email"> Users Email</th>
                                                <th  class="td-users_role_name"> Users Role Name</th>
                                                <th  class="td-users_photo"> Users Photo</th>
                                                <th  class="td-users_password"> Users Password</th>
                                                <th  class="td-users_role_id"> Users Role Id</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-order_Id"><a href="<?php print_link("orders/view/$data[order_Id]") ?>"><?php echo $data['order_Id']; ?></a></td>
                                                    <td class="td-quantity_ordered">
                                                    ...
                                                    <td class="td-users_id"> <?php echo $data['users_id']; ?></td>
                                                    <td class="td-users_user_name">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['users_user_name']; ?>" 
                                                            data-pk="<?php echo $data['order_Id'] ?>" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['users_user_name']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-users_email"><a href="<?php print_link("mailto:$data[users_email]") ?>"><?php echo $data['users_email']; ?></a></td>
                                                    <td class="td-users_role_name">
                                                        <span <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $role_name); ?>' 
                                                            data-value="<?php echo $data['users_role_name']; ?>" 
                                                            data-pk="<?php echo $data['order_Id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="role_name" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['users_role_name']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-users_photo">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['users_photo']; ?>" 
                                                            data-pk="<?php echo $data['order_Id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="photo" 
                                                            data-title="Browse..." 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['users_photo']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-users_password"> <?php echo $data['users_password']; ?></td>
                                                    <td class="td-users_role_id">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['users_role_id']; ?>" 
                                                            data-pk="<?php echo $data['order_Id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="role_id" 
