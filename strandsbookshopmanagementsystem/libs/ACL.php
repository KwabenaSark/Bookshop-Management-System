...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'books' => array('list','view','add','edit', 'editfield','delete','import_data','relation'),
							'inventory' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'orders' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'transactions' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'users' => array('list','view','accountedit','accountview','add','edit', 'editfield','delete','import_data'),
							'report' => array('list','view')
						),
		
			'manager' =>
						array(
							'books' => array('list','view','add','edit', 'editfield','relation'),
							'inventory' => array('list','view','add','edit', 'editfield'),
							'orders' => array('list','view','add')
						),
		
			'clerk' =>
						array(
							'books' => array('list','view','add','relation'),
							'inventory' => array('list','add'),
							'orders' => array('list','view','add')
						)
		);
