                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="quantity_in_stock">Quantity In Stock <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-quantity_in_stock"  value="<?php  echo $this->set_field_value('quantity_in_stock',""); ?>" type="number" placeholder="Enter Quantity In Stock" step="1"  required="" name="quantity_in_stock"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-book_id"  value="<?php  echo $this->set_field_value('book_id',""); ?>" type="number" placeholder="Enter Book Id" step="1"  required="" name="book_id"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
