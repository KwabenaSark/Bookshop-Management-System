                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-users_user_name">
                                        <th class="title"> Users User Name: </th>
                                        <td class="value"> <?php echo $data['users_user_name']; ?></td>
                                    </tr>
                                    <tr  class="td-users_email">
                                        <th class="title"> Users Email: </th>
                                        <td class="value"> <?php echo $data['users_email']; ?></td>
                                    </tr>
                                    <tr  class="td-users_role_name">
                                        <th class="title"> Users Role Name: </th>
                                        <td class="value"> <?php echo $data['users_role_name']; ?></td>
                                    </tr>
                                    <tr  class="td-users_photo">
                                        <th class="title"> Users Photo: </th>
                                        <td class="value"> <?php echo $data['users_photo']; ?></td>
                                    </tr>
                                    <tr  class="td-users_password">
                                        <th class="title"> Users Password: </th>
                                        <td class="value"> <?php echo $data['users_password']; ?></td>
                                    </tr>
                                    <tr  class="td-users_role_id">
                                        <th class="title"> Users Role Id: </th>
                                        <td class="value"> <?php echo $data['users_role_id']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
