                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-quantity_ordered"  value="<?php  echo $this->set_field_value('quantity_ordered',""); ?>" type="number" placeholder="Enter Quantity Ordered" step="1"  required="" name="quantity_ordered"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    ...
                                                                    $checked = $this->set_field_checked('Payment_Type', $value, "");
                                                                    ?>
