                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="transactions-relay-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-orders_order_Id"> Orders Order Id</th>
                                                <th  class="td-orders_quantity_ordered"> Orders Quantity Ordered</th>
                                                <th  class="td-orders_Price"> Orders Price</th>
                                                <th  class="td-orders_Date_Sold"> Orders Date Sold</th>
                                                <th  class="td-orders_Payment_Type"> Orders Payment Type</th>
                                                <th  class="td-orders_user_id"> Orders User Id</th>
                                                <th  class="td-orders_book_id"> Orders Book Id</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-orders_order_Id">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['orders_order_Id']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['orders_order_Id']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-orders_quantity_ordered">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['orders_quantity_ordered']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['order_Id'])); ?>" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['orders_quantity_ordered']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-orders_Price">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['orders_Price']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['order_Id'])); ?>" 
                                                            data-name="Price" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['orders_Price']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-orders_Date_Sold">
                                                        <span <?php if($can_edit){ ?> data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                            data-value="<?php echo $data['orders_Date_Sold']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['order_Id'])); ?>" 
                                                            data-name="Date_Sold" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['orders_Date_Sold']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-orders_Payment_Type">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['orders_Payment_Type']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['order_Id'])); ?>" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['orders_Payment_Type']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-orders_user_id">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['orders_user_id']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['order_Id'])); ?>" 
                                                            data-name="user_id" 
                                                            data-title="Enter User Id" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['orders_user_id']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-orders_book_id">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['orders_book_id']; ?>" 
                                                            data-pk="<?php echo $data['transaction_id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['order_Id'])); ?>" 
                                                            data-name="book_id" 
